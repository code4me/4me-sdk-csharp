...
{
    /// <summary>
    /// A 4me <see href="https://developer.4me.com/v1/workflow_types/">workflow type</see> object.
    /// </summary>
    public class WorkflowType : BaseItem
    {
        ...
        /// <summary>
        /// The Description field is used to enter a very short description of the workflow type, for example “More than 200 workdays or $200K”.
        /// </summary>
        ...
        /// <summary>
        /// The Information field is used to add any additional information about the workflow type that might prove useful, especially for workflow managers when they need to decide which workflow type to select for a workflow.
        /// </summary>
        ...
        /// <summary>
        /// The Name field is used to enter the name of the workflow type. Ideally the name of a workflow type consists of a single word, such as “Large”.
        /// </summary>
        [JsonProperty("name")]
        public string Name
        {
        ...
        /// <summary>
        /// The Position field dictates the position that the workflow type takes when it is displayed in a sorted list.
        /// </summary>
        ...
        /// <summary>
        /// The Reference field is automatically set to the Name field value, written in lower case characters and with all spaces replaced by the underscore character. This reference can be used to link the workflow type to a workflow using the 4me REST API or the 4me Import functionality.
        /// </summary>
