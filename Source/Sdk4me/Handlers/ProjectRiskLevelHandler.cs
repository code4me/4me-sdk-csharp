namespace Sdk4me
{
    public class ProjectRiskLevelHandler : DefaultHandler<ProjectRiskLevel>
    {
        ...
        public ProjectRiskLevelHandler(AuthenticationTokenCollection authenticationTokens, string accountID, EnvironmentType environmentType = EnvironmentType.Production, int itemsPerRequest = 100, int maximumRecursiveRequests = 50) :
